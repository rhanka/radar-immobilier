...
<section class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
  ...
  <div
    class="relative min-h-[430px] overflow-hidden rounded-lg border border-slate-200 bg-slate-50"
  >
    ...
    <div class="absolute left-3 right-3 bottom-2">
      <div class="rounded-md border border-slate-200 bg-white/90 px-3 py-2">
      ...
      <div class="mt-2 max-h-20 overflow-y-auto pr-1 text-[11px] text-slate-600">
        <div class="space-y-1">
          {#each plottedSources as plotted}
            <button
              type="button"
              class={`mr-1 inline-flex w-full max-w-full items-center gap-1 rounded border px-2 py-1 text-left ${
