...
/**
 * QA NAVIGATEUR — UAT round2, correctif m4 (cadrage 2e lot). Rendu réel
...
// Le détail (pane) reste vide : m4 ne dépend pas des signaux.
...
test.describe("UAT round2 — m4 cadrage 2e lot", () => {
