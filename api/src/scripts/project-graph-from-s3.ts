/**
 * project-graph-from-s3 — projette les graphes graphify S3 dans Postgres.
 *
 * Lit `graph/<ville>/latest.json` depuis le bucket configuré (GRAPH_S3_* / SCRAPE_S3_*)
