...
// Calcul superficie extrait vers services/geo/superficie.ts (partagé avec
// l'enrichissement des collections OGC). Comportement identique pour Polygon.
import { superficieFromGeometry } from "../services/geo/superficie.js";
