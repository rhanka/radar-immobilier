...
- [x] **Lot 16 — D7 owner correction: BEFORE / AFTER dossier and readable report.**
  ...
  - [x] Publish a committed offline D7 before/after HTML companion.
  ...
  - [x] Regenerate dated evidence and pass scope/diff/report gates.
