...
try {
  ...
  console.log(await evaluate(`(async () => {
    ...
    try {
      ...
      if (pack.revision !== 'D5' || pack.ownerCorrection.option !== null || pack.note !== note.value || pack.fixedInstructions.reporting.start !== null || pack.fixedInstructions.reporting.captureCutoffs.architectureRuntime !== '2026-09-13T15:38:00Z' || pack.fixedInstructions.reporting.captureCutoffs.transitionImplementation !== '2026-09-13T15:39:00Z' || pack.fixedInstructions.reporting.captureCutoffs.unifiedDeliveryTokenBilling !== null || pack.fixedInstructions.billing.node.projectedAmountCad !== null || 'decision' in pack || 'options' in pack) throw Error('Real clipboard content mismatch');
