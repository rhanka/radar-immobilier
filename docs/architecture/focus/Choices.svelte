...
<section class="choices" aria-labelledby="instruction-title">
  ...
  <div class="option-grid" aria-label="Instructions de facturation D5">
    <Tile><Stack gap={3}><Flex justify="between" wrap gap={2}><Badge tone="warning">Période non fermée</Badge></Flex><h3>Fenêtre demandée</h3><p>Début = frontière réelle de la facture/du rapport précédent, encore non vérifiée. Fin = 13 septembre inclus, soit <code>2026-09-14T00:00:00-04:00</code> exclusif.</p><dl><div><dt>Cutoffs des preuves</dt><dd>15:38Z/15:39Z sont les contrôles antérieurs horodatés. Le suivi T1/T2/T3 est daté du 13 sans heure UTC exacte; le cutoff unifié reste non gelé.</dd></div><div><dt>Transitions du 13</dt><dd>Dans la période demandée, distinguées entre observées et planifiées.</dd></div></dl></Stack></Tile>
