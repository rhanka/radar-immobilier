...
const sharedNodes = {
  ...
  PP_DOCS: immo('s3', 'S3 compatible · MinIO', 'Fallback API dérivé · bucket vide', 'radar-immobilier:api/src/config.ts; api/src/routes/documents.ts'),
  PP_DOCS_LEGACY: immo('s3', 'S3 compatible · MinIO', 'Historique/rejeu utile · rétention T2', 'architecture.md:September 13 partial MinIO inventory'),
