...
export const fixedInstructions = {
  ...
  transitionEvidence: {
    ...
    t1: { graphify: '0.18.0', llmMesh: '0.19.0', socketFailurePolicy: 'fail Job closed; resume durable state next cycle; no in-process retry', llmMesh0191Required: false, llmMesh0191Assessment: 'probably false and not prioritized', crossRepoAuthorized: false, closedPr: 585, branchesRemoved: true, diagnosticOwner: 's-conductor', implementationRequested: false, fableBlockAt: 'ac3a7150', correctiveCommits: ['537b9e0c', '3d9ed43c'], tests: { scoped: '34/34', integration: '4/4', typecheck: 'pass' }, fableRereview: 'in progress', providerSignal: false, kubernetesAcceptance: false, status: 'BLOCKED' },
