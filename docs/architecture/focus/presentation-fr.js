...
Graphify **0.18.0 est publié**. À 15:39 UTC, Immo avait commité les dépendances **d0595d9f**, passé le **typecheck** et lancé les tests ciblés; l’intégration est en cours, pas acceptée. Le keyring opéré, le lock durable et les preuves bout en bout restent ouverts. T1 garde les rôles API MinIO existants jusqu’à T2; Geo fournit les données/preuves géographiques sans posséder le traitement PV Immo.
