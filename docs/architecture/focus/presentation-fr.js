...
Graphify reste épinglé à **exactement 0.18.0** et fail-close correctement. **immo-pv-extraction-v3** est le nom du contrat PDF interne, pas une version 0.18.3. Fable a rendu **BLOCK** à **ac3a7150**. Les correctifs **537b9e0c + 3d9ed43c** passent scoped **34/34**, intégration **4/4** et typecheck; la re-review Fable reste en cours. T1 reste **BLOCKED**. Aucun Signal fournisseur réel ni acceptation Kubernetes n’existe encore.
