...
**Méthode** : tous les chiffres de ce rapport sont mesurés sur la fenêtre Montréal `2026-08-12T00:00:00-04:00` → `2026-09-10T23:59:59-04:00` : historique premier parent et tags de `origin/main`, PR mergées, journal Track local et état d'exploitation relevé le 11 septembre. Les captures d'écran proviennent de l'application en préproduction (même code que la production, SHA `831cad2` = v1.2.5, vérifié avant chaque prise), prises le 11 septembre 2026 par session authentifiée.
