# T1 v11 campaign — LOW with extraction contract v7

- Experimental delta from v10: only T1 profile commit
  `5068dda38bffe8659a85c2e51f566fb9c6ad4584` and its derived profile,
  corpus validator, prompt, schema, hash, and byte-size fields.
- The manifest and manual oracle are byte-identical to v10 apart from the
