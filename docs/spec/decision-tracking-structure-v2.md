...
| **WP7** PLATEFORME | 21 | `WP Persistance S3-first` (+6 : **lots L1–L6**) · `WP A.3 — Infrastructure data & agents` (+4) · Auth durable Sentropic · P5 Admin validation view · Déploiement k8s · graphify → DB graphe Postgres · Mount S3 object store · CS-P3 (sync + AUTH) · chat.test.ts clés provider |
