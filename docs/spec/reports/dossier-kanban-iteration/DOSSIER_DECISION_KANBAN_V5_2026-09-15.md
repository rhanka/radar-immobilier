# Dossier de décision — Kanban GitHub et itération v5

Date : 2026-09-15 · Conductor : `i-cond` · Statut : **PRÊT POUR RE-REVUE SUR DIFF, NON APPLIQUÉ**.

Sources relues : re-revues Astra et Fable v4; dossier owner du 2026-09-14; verbatim owner du 2026-09-15; Track immo et geo en lecture seule; PR #694 au head `513e173ef38c7b6642f8e3fe0758a701f25f2c70` avant édition; schéma GraphQL GitHub. Aucun acte GitHub ou Track n'a été exécuté.

## 1. Synthèse et ratification demandée

- `IT5=apply` ratifie ce dossier et la matrice K01–K15; `IT5=revise` interdit toute écriture Track, GitHub ou repli. La garde exige deux avis favorables portant chacun les SHA-256 complets du plan **et** du dossier v5.
...
- Le calendrier de référence, si IT5 est ratifiée le 15/09, est exprimé en jours ouvrés : mardi 15/09, mardi 22/09, mardi 29/09 et mardi 06/10; il glisse par semaines entières sinon. Une fenêtre de cinq jours ouvrés contient au plus 60 minutes réservées. La capacité exécutant reste `source-gap`; les cibles ne prouvent pas la capacité de production.
...
`JO+0` est le premier mardi où IT5 est ratifiée. Les dates ci-dessous valent pour une ratification le mardi 15/09/2026; une ratification ultérieure décale les quatre dates par semaines entières. Les créneaux hebdomadaires du mardi empêchent qu'une fenêtre de cinq jours ouvrés contienne deux réservations.
...
| JO+5 | mar. 2026-09-22 | K01, K03 · 15 min chacun; K14 · 12 min | 42 min | K01 close avant démarrage K02; socle K03 et gate K14 acceptés |
...
Chemin critique : K11 → K01 (22/09) → K02 (29/09) → K10 (06/10). Les UAT de K11/K12/K13/K15 sont asynchrones et hors de la réservation hebdomadaire agrégée. Les horaires, le parallélisme et la capacité exécutant sont `source-gap`; sans mesure de capacité, chaque date est une cible conditionnelle.

## 7. Plan de commandes, non exécuté

1. Produire deux revues v5 sur le même couple d'octets. Chacune porte exactement un verdict favorable, un `plan-sha256` complet et un `dossier-sha256` complet.
...
4. Avant toute mutation, G retrouve les IDs Q1/IT5 fournis par T et vérifie option sélectionnée, outcome, cibles, contexte et deux hashes; toute absence ou divergence arrête. Il contrôle ensuite les listes exhaustives de projets et cartes. Une valeur de statut est écrite uniquement dans la branche où l'ajout d'une nouvelle carte vient d'être prouvé.
...
Question owner : `IT5=apply` accepte les 15 cartes, les deux `source-gap` de §1, le hold K02 complet, le calendrier recalculé, K04 gatée par K03+K14 et le repli; `IT5=revise` n'autorise aucune écriture.
