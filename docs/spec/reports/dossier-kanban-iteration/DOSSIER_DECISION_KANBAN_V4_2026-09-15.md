# Dossier de décision — Kanban GitHub et itération v4

Date : 2026-09-15 · Conductor : `i-cond` · Statut : **PRÊT POUR RE-REVUE SUR DIFF, NON APPLIQUÉ**.

Sources relues : re-revues Astra et Fable v3; dossier owner du 2026-09-14; verbatim owner du 2026-09-15; Track immo et geo en lecture seule; PR #694 au head `eacc22935366fee7303fd1eb779f922b501c81de`; schéma GraphQL GitHub. Aucun acte GitHub ou Track n'a été exécuté.

## 1. Synthèse et ratification demandée

- `IT4=apply` ratifie ce dossier et la matrice K01–K15; `IT4=revise` interdit toute écriture Track, GitHub ou repli. La garde exige deux avis favorables portant chacun les SHA-256 complets du plan **et** du dossier v4.
...
- La surface reste de 15 issues : 8 P1 et 7 P2. Les 15, K14 comprise, démarrent dans `À prioriser`; une carte existante ne reçoit jamais une nouvelle valeur `Status` au rejeu.
- Track est l'autorité de la réalisation, des décisions, des dépendances et de la priorité. Le Project v2 est une projection; toute divergence arrête l'exécution.
...
- Le calendrier est exprimé en jours ouvrés : mardi 15/09, mardi 22/09, mardi 29/09 et mardi 06/10. Une fenêtre de cinq jours ouvrés contient au plus 60 minutes réservées. La capacité exécutant reste `source-gap`; les cibles ne prouvent pas la capacité de production.
...
| K12 | Requalifier Jalon 1 : recall, ontologie, ground truth | geo+immo · WP5 jointures proposé · WP immo proposé | P1 | À prioriser | source-gap | 12 min · JO+0 · 15/09 | source-gap | 2026-09-22 | — |
...
| K14 | Cadrer puis lancer le LLM in-cluster geo | geo · WP7 socle · WP immo proposé | P2 | À prioriser | source-gap | 12 min · JO+10 · 29/09 | source-gap | 2026-09-29 | gate K04; bloque K05/K06 sur leurs nœuds LLM |
...
`JO+n` compte les jours ouvrés après le mardi 15/09/2026. Les créneaux hebdomadaires du mardi empêchent qu'une fenêtre de cinq jours ouvrés contienne deux réservations.

| Jour ouvré | Date | Validation agrégée | Total | Sortie visée |
|---|---|---|---:|---|
| JO+0 | mar. 2026-09-15 | K11, K12, K13, K15 · 12 min chacun; arbitrages IT4 · 12 min | 60 min | gates P1 et deux `source-gap` ratifiés |
| JO+5 | mar. 2026-09-22 | K01, K03 · 15 min chacun | 30 min | K01 close avant démarrage K02; socle K03 accepté |
| JO+10 | mar. 2026-09-29 | K02, K04, K05, K09, K14 · 12 min chacun | 60 min | K02 après K01; contrats/canaris P2 |
| JO+15 | mar. 2026-10-06 | K10, K06, K07, K08 · 15 min chacun | 60 min | K10 après K02; UAT P2 |

Chemin critique : K11 → K01 (22/09) → K02 (29/09) → K10 (06/10). Les horaires, le parallélisme et la capacité exécutant sont `source-gap`; sans mesure de capacité, chaque date est une cible conditionnelle.

## 7. Plan de commandes, non exécuté

1. Produire deux revues v4 sur le même couple d'octets. Chacune porte exactement un verdict favorable, un `plan-sha256` complet et un `dossier-sha256` complet.
...
4. G contrôle les listes exhaustives de projets et cartes avant toute absence conclue. Une valeur de statut est écrite uniquement dans la branche où l'ajout d'une nouvelle carte vient d'être prouvé.
...
Question owner : `IT4=apply` accepte les 15 cartes, les deux `source-gap` de §1, le calendrier recalculé, K04 gatée par K03+K14 et le repli; `IT4=revise` n'autorise aucune écriture.
