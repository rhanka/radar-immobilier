...
const DOSSIER = '../DOSSIER_DECISION_M1_REFRESH_2026-09-14.md';
...
// demandées, puis l'annexe. Le texte n'est pas réécrit, seulement découpé.
...
if (!annexes.length) throw Error('missing the glossary annexe');
...
const manifest = {
  schema: 'immo-focus-m1-decision-map/v1',
  dossier: 'docs/spec/reports/dossier-m1-refresh/DOSSIER_DECISION_M1_REFRESH_2026-09-14.md',
