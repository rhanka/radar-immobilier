...
neighbors (up to 12):
- [est_affectée_par] Marge d'implantation (marge_implantation) [walkthrough-transcript.md]
- [mentionne] Walkthrough démo radar-immobilier — transcript (radar_demo_transcript) [walkthrough-transcript.md]
- [modifie] Règlement de zonage (règlement_zonage) [walkthrough-transcript.md]
...
/home/antoinefa/src/radar-immobilier/docs/spec/input/walkthrough/.graphify/.graphify/wiki/descriptions/d-rogation_mineure.json
