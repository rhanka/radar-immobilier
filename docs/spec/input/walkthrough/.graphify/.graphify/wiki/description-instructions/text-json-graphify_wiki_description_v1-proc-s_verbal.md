...
neighbors (up to 12):
- [contient] Avis de motion (avis_de_motion) [walkthrough-transcript.md]
- [contient] Avis public municipal (avis_public) [walkthrough-transcript.md]
- [contient] Changement de zonage (zonage_change) [walkthrough-transcript.md]
- [contient] Règlement de zonage (règlement_zonage) [walkthrough-transcript.md]
...
/home/antoinefa/src/radar-immobilier/docs/spec/input/walkthrough/.graphify/.graphify/wiki/descriptions/proc-s_verbal.json
